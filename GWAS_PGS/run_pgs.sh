...
#SBATCH -o /home/mcostantino/job-output/run_PGS/run_PGS_%A_%a.out
#SBATCH -e /home/mcostantino/job-output/run_PGS/run_PGS_%A_%a.err
...
# make file containing the different P-value thresholds for inclusion of SNPs in the PRS
