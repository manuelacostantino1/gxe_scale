...
#SBATCH -o /home/mcostantino/job-output/run_PGS/compare_gwas.out
#SBATCH -e /home/mcostantino/job-output/run_PGS/compare_gwas.err
...
threshold=5e-8
output_file="/gpfs/data/ukb-share/dahl/manuela/scale_project/gwas_sharing.txt"
...
for pheno in "${PHENOARRAY[@]}"; do
    ...
    gwas1="/gpfs/data/ukb-share/dahl/manuela/joined_gwas_results/${pheno}/chr1-22_whitebrit_${pheno}.assoc.linear"
    gwas2="/gpfs/data/ukb-share/dahl/manuela/joined_gwas_results_log/${pheno}/chr1-22_whitebrit_${pheno}.assoc.linear"
    union_gwas="/scratch/mcostantino/descaler/union_gwas/${pheno}_union.assoc.linear"
    clump_file="/scratch/mcostantino/descaler/union_gwas/clumped_genos/${pheno}"
    valid_snp_file="/scratch/mcostantino/descaler/union_gwas/clumped_genos/${pheno}.valid.snp"
