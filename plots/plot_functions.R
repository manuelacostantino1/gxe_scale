prs_list <- c("BMI", "age_menopause", "chrons", "melanoma", "CVD", "alzheimers", "coeliac", "osteoporosis", "ulcerative_colitis", "HBA1C", "arthritis", "coronary_artery", "ovarian_cancer", "venous_thromboembolic", "HDL", "asthma", "glaucoma", "parkinsons", "LDL", "atrial_fibrillation", "height", "prostate_cancer", "MS", "bipolar", "hypertension", "psoriasis",  "bone_mineral_density", "intraocular_pressure", "schizophrenia", "T1D", "bowel_cancer", "lupus", "stroke", "T2D", "breast_cancer", "macular_degenration")
...
lambdashort <- c(0.00000000,  0.06122449,  0.18367347, 0.30612245,  0.42857143,  0.55102041,  0.67346939,  0.79591837,  0.91836735,  1.00000000)
